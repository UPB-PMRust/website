...
### Week 12
Configured the driver for the LED strip and pushed forward testing 'Manual' mode and knob changes for it. Configured the EEPROM and Bluetooth module and made the custom app for the latter.

### Week 13
Tested all functionalities and began designing the lamp prototype using cardboard and extra wiring.
