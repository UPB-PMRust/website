...
```
  ...
  Edit the file `.zed/settings.json`:
...
Edit the file `.helix/languages.json`:
  ```json
[[language]]
name = "rust"
...
When working on embedded Rust projects (like our STM32U5 or RP2040 firmware), having a well‑configured editor makes development smoother and debugging less painful. Here are three excellent options — Visual Studio Code, Zed, and Helix — with setup instructions and recommendations.
