...
If you forget to enable this feature, the linker will fail with an error because the required synchronization symbols are missing. To fix this, update your `Cargo.toml` like so:
