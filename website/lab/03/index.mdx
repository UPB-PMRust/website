...
Because of this wiring, the default PWM polarity (`ActiveHigh`) will feel inverted:
...
```rust
// Make sure to replace `channel` with the correct channel of you `TIMx` peripheral(e.g. ch1)
ch1.set_polarity(OutputPolarity::ActiveLow);
```
