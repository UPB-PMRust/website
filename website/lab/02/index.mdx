...
with [Embassy](https://embassy.dev) for the RP2350 STM32U545 MCU.
...
4. **DS14217**, *[STM32U545 Datasheet](https://www.st.com/resource/en/datasheet/stm32u535cb.pdf)*
...
The STM32U545, RP2040 and RP2350 have three peripherals that control the GPIO pins:
...
There are 3 different ways in which the hardware—either the STM32 Nucleo-U545RE-Q or the Raspberry Pi Pico 2—can be used:
...
// initialize PX_n (replace x with a letter(see the datasheet) and n with a number) and set its
