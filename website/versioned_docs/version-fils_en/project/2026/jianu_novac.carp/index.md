# RustInjector(may change if i feel more inspired)
...
An RC car controlled via Wi-Fi from a mobile phone, designed to jump approximately 75cm (average desk height) and land safely to perform a physical USB injection attack on a target laptop.The design may resemble a monster truck toy to "camuflage" better. 
...
### Week 20 - 25 April
ordered online 99% of all the components i need.I need to find a place that sells industrial spring 
### Week 5 - 11 May
