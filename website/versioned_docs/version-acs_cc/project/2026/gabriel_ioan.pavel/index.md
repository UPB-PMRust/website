...
- Decodificare: Un timer asincron monitorizează starea pinului RX. Un algoritm de discriminare a duratei impulsurilor
...
un buzzer, un LED, condensatori și rezostori.
...
| Fire de cupru de 17.3cm | Antene | ~2 RON / metru |
...
| [mipidsi](https://crates.io/crates/mipidsi) | Driver pentru LCD | Interfațare cu ecranul de 1.44\'\' |
